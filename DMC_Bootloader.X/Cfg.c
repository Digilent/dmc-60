...
/*  09/19/2016 (MichaelA): modified CfgInit() to use the default device */
/*      number from Can.h                                               */
...
//__psv__ extern const WORD __attribute__((space(psv), address(_FWVERBOOT))) _FWVERBOOT_;

//extern const WORD _FWVERBOOT @ 0x157EA;
...
CfgInit() {
    ...
    /* Disable interrupts. M00TODO make sure this is necessary.
    */
    DISABLE_INTERRUPTS
    ...
    */
    if (( mgkWord1 != pmtrcfgCur->mgk1 ) || ( mgkWord2 != pmtrcfgCur->mgk2 )) {
        ...
        pmtrcfgCur->ver = verMtrCfgBootloader;
...
**
**  Description:
**      This function performs any cleanup required to de-initialize
**      the module.
*/
void
CfgTerm() {
...
**
**  Description:
**      This routine reads the string descriptor section of flash memory into
**      RAM copy of the string descriptor table. If the string descriptor table
**      is not present in flash or has been corrupted then the RAM copy is
**      default initialized and written to flash memory.
**
**  Notes:
**      Interrupts must be disabled to ensure that this operation as atomic. It
**      Is the callers responsbility to disable and re-enable interrupts.
...
CfgReadStrDescFromFlash() {
    ...
    */
    if (( mgkWord1 != strdescCur.mgk1 ) || ( mgkWord2 != strdescCur.mgk2 )) {
        ...
        strdescCur.ver = verStrDescBootloader;
